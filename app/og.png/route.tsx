      ...
      >
        ...
        <div
          style={{
            ...
            width: 1200,
            height: 630,
            background: "linear-gradient(180deg, rgba(20,32,43,0.97) 0%, rgba(20,32,43,0.85) 55%, rgba(20,32,43,0.25) 100%)",
          }}
        />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <svg width="84" height="74" viewBox="92 112 170 150" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M143 219 192 142 242 219" stroke="#f4efe6" strokeWidth="13" />
            <path d="M175 176 186 168 193 177 201 168 210 176" stroke="#f4efe6" strokeWidth="8" />
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ fontSize: 15, letterSpacing: 6, color: "#e07a3f", marginTop: 6, fontFamily: "IBM Plex Mono" }}>WEB SOLUTIONS</div>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", color: "#e07a3f" }}>small businesses.</div>
        </div>
