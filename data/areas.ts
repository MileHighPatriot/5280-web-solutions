...
export const areas: Area[] = [
  {
    ...
    local:
      "From neighborhood restaurants on Tennyson and South Broadway to contractors working across the metro, Denver businesses compete on first impressions. I build sites that load fast, look sharp on a phone, and make it obvious how to call, book, or get a quote. I'm local and can meet in person anywhere in the city.",
  ...
  },
  {
    ...
    local:
      "Whether you run a restaurant on East Colfax, a service business near Southlands, or a crew working the new subdivisions out east, a clean, professional website helps new neighbors find and trust you. I keep your services, hours, and contact info front and center.",
  ...
  },
  {
    ...
    local:
      "Lakewood's shops, landscapers, and service businesses rely on local word of mouth. A good website backs that up when someone searches your name after a referral. I focus on clear services, real photos, and a Google Business Profile that matches your site.",
  ...
  },
  {
    ...
    local:
      "From Pearl Street retail to wellness studios and outdoor outfitters, Boulder businesses need sites that match the quality of what they sell. I build fast, clean, modern sites that feel premium without a premium agency price tag.",
  ...
  },
  {
    ...
    local:
      "Old Town shops, breweries, trades, and service businesses across Northern Colorado all compete for the same local searches. I'll make sure your site and Google profile tell people exactly what you do and where, so the buy-local crowd can actually find you.",
  ...
  },
  {
    ...
    local:
      "From Old Colorado City to the new neighborhoods on the east side, Springs businesses need to be easy to find and easy to contact. I build sites that load fast, rank for local searches, and make calling you the obvious next step.",
